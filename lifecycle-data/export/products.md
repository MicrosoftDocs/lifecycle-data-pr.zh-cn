...
ms.locfileid: "903643"
---
# <a name="lifecycle-data-export"></a><span data-ttu-id="f0483-103">生命周期数据导出</span><span class="sxs-lookup"><span data-stu-id="f0483-103">Lifecycle data export</span></span>

> [!IMPORTANT]
> <span data-ttu-id="f0483-104">此页面正在开发中。</span><span class="sxs-lookup"><span data-stu-id="f0483-104">This page is under development.</span></span>

## <a name="export-all-products"></a><span data-ttu-id="f0483-105">导出所有产品</span><span class="sxs-lookup"><span data-stu-id="f0483-105">Export all products</span></span>
<span data-ttu-id="f0483-106">单击以下内容以导出所有产品的生命周期数据：</span><span class="sxs-lookup"><span data-stu-id="f0483-106">Export lifecycle data for all products by clicking below:</span></span>

> [!div class="nextstepaction"]
> [<span data-ttu-id="f0483-107">导出所有产品</span><span class="sxs-lookup"><span data-stu-id="f0483-107">Export All Products</span></span>](https://app-omaha-prod.azurewebsites.net/api/PublishedListings/Export)

## <a name="export-products-by-family-and-group"></a><span data-ttu-id="f0483-108">按家庭和群组导出产品</span><span class="sxs-lookup"><span data-stu-id="f0483-108">Export products by Family and Group</span></span>
<span data-ttu-id="f0483-109">选择一家系列，然后选择要导出的组。</span><span class="sxs-lookup"><span data-stu-id="f0483-109">Select a Family and then a Group to export.</span></span> <span data-ttu-id="f0483-110">注意：在选择组值后，将开始导出。</span><span class="sxs-lookup"><span data-stu-id="f0483-110">Note: Export will begin when Group value is selected.</span></span> 
...
## <a name="export-products-by-end-of-support-date"></a><span data-ttu-id="f0483-169">在支持日期结束时导出产品</span><span class="sxs-lookup"><span data-stu-id="f0483-169">Export products by end of support date</span></span>
<span data-ttu-id="f0483-170">选择一年时间，查看产品支持终端。</span><span class="sxs-lookup"><span data-stu-id="f0483-170">Select a year to see products reaching the end of support.</span></span> <span data-ttu-id="f0483-171">注意："导出将在选择年度"值后开始。</span><span class="sxs-lookup"><span data-stu-id="f0483-171">Note: Export will begin when Year value is selected.</span></span>
